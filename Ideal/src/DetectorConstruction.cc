...
//--------------------------------------------------------------------------------------
    ...
    fDetectorVolume = new G4LogicalVolume(solidDetector, silicon, "SiDetector");
        ...
        rot1->rotateZ(-120.0006*deg);
        rot1->rotateY(131.7015*deg);
        ...
        rot3->rotateZ(120.0006*deg);
        rot3->rotateY(131.7015*deg);
        ...
        rot4->rotateZ(-60.0034*deg);
        rot4->rotateY(114.4788*deg);
        ...
        rot6->rotateZ(60.0034*deg);
        rot6->rotateY(114.4788*deg);
